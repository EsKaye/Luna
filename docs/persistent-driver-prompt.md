# Persistent Codex Driver Prompt
...
This prompt can be applied to any repository in the ShadowFlower–MKWW network to keep autonomous agents aligned with the grand design.
